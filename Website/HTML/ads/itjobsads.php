...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	...
	<body bgcolor="#ffffff" id="body">
     ...
     <?php
	  ...
	  require_once('../IT_Jops_class.php');
	   require_once('../../Controler.php');
	 
if(isset($_POST['submitbutton'])){
	if($_POST['skills'] =="" ||$_POST['adsname'] =="" || $_POST['adsplace'] =="" ||$_POST['Salary'] =="" ||$_POST['experience'] =="" ||$_POST['type'] ==""  ){
echo '<script>window.alert("one or more field are requeried")</script>';
	...
	$adsobj->category='It_jobs';
	$adsobj->Description= $_POST['Description'];
	
	$itobj = new IT_Jops;
	$itobj->Salary = $_POST['Salary'];
	$itobj->years_of_experience =$_POST['experience'];
	$itobj->Type = $_POST['type'];
	$itobj->Skills = $_POST['skills'];
	
	$controlobj = new Controler;
	$controlobj->createAds($adsobj,null,null,$itobj,3);
...
?>
    ...
    <option value="itjobslists.php">It jobs List</option>
       ...
       <form id="create" method="post" >
         <font face="fantasy" color="#33817f" size="5" >
         <center> Advertisement for It jobs </center>
...
<br>
         ...
         <input type="text" name="Salary" style=" height:20px; width:200px; " > 
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;
         <input type="text" name="experience" style=" height:20px; width:200px; " > <br>
          &nbsp;&nbsp;&nbsp;&nbsp;Type of job : <br>	 &nbsp;&nbsp;&nbsp;&nbsp;				
         <input type="text" name="type" style=" height:20px; width:200px; " > <br>
          &nbsp;&nbsp;&nbsp;&nbsp; Skills :	<br>&nbsp;&nbsp;&nbsp;&nbsp;
        <textarea name="skills" rows="6" cols="100" style="max-width:600px; max-height:100px;"></textarea>
